...
public:
    ...
    explicit Contents_SCL(int size) : l(size), s(size), is_frozen_bit(false) {}
...
protected:
    ...
    void recursive_allocate_nodes_contents(Node<Contents_SCL>* node_curr, const int vector_size);

...
void frozen_bits_generator_PW(const int& N, const int& Kz, const int& Kx, vector<bool>& Z_code_frozen_bits, vector<bool>& Z_stab_frozen_bits, double beta=pow(2, 0.25));
...
bool construct_frozen_bits(CONSTRUCTION con, const int& N, const int& Kz, const int& Kx, vector<bool>& Z_code_frozen_bits, vector<bool>& Z_stab_info_bits, double beta=pow(2,0.25));
